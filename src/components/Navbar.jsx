	...
	return (
		<div>
			<nav className="fixed left-0 right-0 z-50 lg:top-4">
				{/*Desktop Menu*/}
				<div className="mx-auto hidden min-w-fit max-w-xl items-center justify-center rounded-full border border-white/30 py-2 backdrop-blur-lg lg:flex">
				...
				{/*Mobile Menu*/}
				<div className="px-4 py-2 backdrop-blur-md lg:hidden">
